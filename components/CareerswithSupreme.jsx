            ...
            <main className="flex flex-col md:flex-row max-w-6xl w-full rounded-lg overflow-hidden">
                ...
                <div className="w-full md:w-1/2 p-6 md:p-12">
                    ...
                    <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 md:justify-center">
                        <Link href="/contact" className="bg-gradient-to-r from-amber-700 to-yellow-600 text-white px-6 py-3 rounded-md font-semibold hover:bg-red-600 transition duration-300 text-center">
                            JOIN SUPREME
                        </Link>
