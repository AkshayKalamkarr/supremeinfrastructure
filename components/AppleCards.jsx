...
export function AppleCardsCarouselDemo() {
  ...
  return (
    <div className='w-full h-full py-20 mt-22 md:mt-36 bg-white'>
      <h2 className='max-w-7xl pl-4 mx-auto text-xl md:text-5xl font-bold text-black dark:text-neutral-200 font-sans text-center'>
