        ...
        <div className="bg-opacity-90 p-6 sm:p-8 md:p-10 lg:p-0 rounded-lg max-w-sm sm:max-w-md md:max-w-lg lg:max-w-4xl xl:max-w-6xl text-center">
          ...
          <motion.div variants={buttonVariants}>
            <Link href='/about/supremeInfrastructure'>
              <motion.button
                className="px-6 sm:px-8 py-3 bg-amber-700 text-white font-semibold rounded-full hover:bg-orange-600 transition-colors duration-300 text-sm sm:text-base md:text-lg lg:text-xl shadow-lg"
