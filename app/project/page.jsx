...
export default function Project() {
    ...
    if (selectedProject) {
      const interval = setInterval(() => {
        setCurrentImageIndex(
          (prevIndex) => (prevIndex + 1) % selectedProject.galleryImages.length
        );
      }, 2000);
  ...
  return (
    <div className='flex flex-col lg:flex-row min-h-screen bg-gray-100'>
      ...
      >
        <h2 className='text-2xl font-bold mb-6 text-center lg:my-12'>
          PROJECTS
        </h2>
          ...
          {projects.map((project, index) => (
            ...
            >
              <button
                ...
                className={`w-full text-left px-4 py-2 rounded-md transition-colors duration-200 md:text-center ${
            ...
            >
              ...
              <div className='h-[40vh] lg:h-[30vh] relative overflow-hidden'>
                <motion.div
                  ...
                  style={{
                    backgroundImage: `url('${selectedProject.backgroundImage.image}')`,
                  }}
                  initial={{ scale: 1.1 }}
                  animate={{ scale: 1 }}
              ...
              <div className='container mx-auto px-4 py-8'>
                <div className='flex flex-col lg:flex-row gap-8'>
                  ...
                  >
                    <div className='rounded-lg p-6'>
                      ...
                      <ul className='space-y-3'>
                        {selectedProject.projectInformation.map(
                          (info, index) => (
                            <motion.li
                              key={index}
                  ...
                  >
                    <div
                      className='relative h-64 lg:h-[570px] rounded-lg overflow-hidden shadow-lg cursor-pointer'
                    ...
                    >
                      <AnimatePresence initial={false}>
                        <motion.img
                          ...
                          src={
                            selectedProject.galleryImages[currentImageIndex]
                              .image
                          }
                          alt={
                            selectedProject.galleryImages[currentImageIndex].alt
                          }
                ...
                >
                  <h2 className='text-2xl font-semibold mb-4 text-gray-800 md:mx-56'>
                    Project Features
                  </h2>
