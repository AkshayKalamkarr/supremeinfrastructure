  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-gray-200 to-gray-200">
      ...
      >
        ...
        >
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-amber-600 tracking-wide text-center drop-shadow-lg">
      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-amber-600 border-b-4 border-amber-600 pb-2 text-center">
              Contact Info
            </h2>
            ...
            <div className="mt-8 text-center">
              <h3 className="text-xl font-semibold mb-4 text-amber-600">Follow Us</h3>
              <div className="flex justify-center space-x-4">
                {[FaFacebookF, FaTwitter, FaInstagram, FaLinkedinIn].map((Icon, index) => (
                  <motion.a
                    key={index}
                    href="#"
                    className="text-amber-600 hover:text-blue-700 transition-colors duration-300"
          ...
          <motion.div
            ...
            className="bg-white p-6 md:p-8 shadow-md rounded-lg"
          >
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-amber-600 border-b-4 border-amber-600 pb-2 text-center">
              Send Us a Message
            </h2>
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                <input
                  ...
                  required
                  className="w-full p-3 md:p-4 border-2 border-amber-300 focus:border-blue-500 outline-none rounded transition duration-300"
                />
                <input
                  type="email"
                  name="email"
              ...
              <motion.button
                type="submit"
                className="w-full bg-amber-600 text-white py-3 rounded hover:bg-blue-900 transition duration-300 text-lg font-semibold"
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold mb-6 text-amber-600 text-center border-b-4 border-amber-600 pb-2">
            Location
          </h2>
