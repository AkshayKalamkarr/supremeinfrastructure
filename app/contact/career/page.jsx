                        ...
                        {jobs.map((job, index) => (
                            ...
                            >
                                <motion.div className="text-4xl mb-4 flex justify-center">
                                    <job.icon className="text-amber-600" />
                                </motion.div>
                ...
                <section className="flex flex-col lg:flex-row gap-12">
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        <form onSubmit={handleSubmit} className="bg-white rounded-lg p-6 md:p-8 border-2 border-blue-200">
                            ...
                            <motion.button
                                type="submit"
                                className="w-full bg-gradient-to-r from-amber-700 to-yellow-600 hover:bg-blue-700 text-white text-lg font-bold py-3 px-6 rounded-lg transition duration-300"
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                            >
                                Submit Application
