        ...
        <div className="min-h-screen bg-gray-100">
            ...
            <div className="bg-cover bg-center h-[calc(100vh-80px)] md:h-screen relative" style={{ backgroundImage: "url('/images/about/about.jpg')" }}>
                <div className="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center">
                    <h1 className="text-4xl md:text-6xl font-bold text-white text-center px-4">Building Tomorrow's <span className='text-orange-500'>World Today</span> </h1>
                </div>
            </div>
            ...
            <main className="container mx-auto w-full px-4 py-16">
                ...
                <section className="text-center">
                    ...
                    <Link href='/contact'>
                        <motion.button
                            className="bg-amber-600 text-white px-8 py-3 rounded-full text-lg font-semibold hover:bg-blue-700 transition duration-300"
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                        >
                            Contact Us Today
